      ...
      <div className="flex justify-around mt-2">
        ...
        <div className="m-8 flex gap-14 mr-40">
          ...
          <div className="flex text-white gap-3 mt-0 ml-11 border border-solid border-white rounded-3xl p-3 pt-5">
            <div>
              <IoIosKeypad className="object-cover w-7 h-7 pb-1 hover:text-cyan-400 transform hover:scale-110 transition duration-300 ease-out" />
            </div>
           <a className="relative cursor-pointer hover:text-cyan-400 transform hover:scale-105 transition duration-300 ease-out after:content-[''] after:absolute after:left-0 after:-bottom-1 after:w-1 after:h-[2px] after:bg-cyan-400 after:transition-all after:duration-300 hover:after:w-full">
              EXPOSURE
            </a>
          </div>
